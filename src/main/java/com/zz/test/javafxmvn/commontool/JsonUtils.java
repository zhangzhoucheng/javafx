 ...
 * ------------------------------------------------------------------------------------------------------  
 * 1.0 		  2020-01-15 12:26:55    jld.zhangzhou     mobile base 3th,BeiJing      1.create the class            
 * </note>
 */
public class JsonUtils {
    ...
    /**
     * <pre>
     * Desc  将对象转换成json字符串格式（默认将转换所有的属性）
     * &#64;param value
     * &#64;return
     * &#64;author peter.fu
     * Jul 3, 2017 3:22:33 PM
     * </pre>
     */
	...
	try {
	    objectMapper.writer(new SimpleFilterProvider().addFilter(AnnotationUtils.getValue(AnnotationUtils.findAnnotation(value.getClass(), JsonFilter.class)).toString(),
    ...
    /**
     * 解析json属性，放到实体里面去 @Title: readJsonList @param jsondata @param collectionClass @return 设定文件 List<SpecVO> 返回类型 @throws
     */
