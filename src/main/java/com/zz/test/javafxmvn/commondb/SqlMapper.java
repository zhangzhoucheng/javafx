/**
 * com.hpe.bbc.common.SqlMapper.java Copyright (c) 2017 xx Development Company, L.P. All rights reserved.
 */
 ...
 */
//@Service
public class SqlMapper extends SqlSessionDaoSupport {
    ...
    /**
     * <pre>
     * 如果一些系统直接从mybatis-spring1.1.1升级到1.2版本的时候,需要这个，
     * 否则找不到SqlSessionFactory http://www.cnblogs.com/rollenholt/p/3358650.html
     * </pre>
     */
    @Override
    @Autowired
	...
	this.msUtils = new MSUtils(getSqlSession().getConfiguration());
    }
	...
	return getSqlSession().selectList(msId);
    }
	...
	return getSqlSession().selectList(msId, value);
    }
	...
	return getSqlSession().insert(msId);
    }
	...
	return getSqlSession().insert(msId, value);
    }
	...
	return getSqlSession().update(msId);
    }
	...
	return getSqlSession().update(msId, value);
    }
	...
	return getSqlSession().delete(msId);
    }
	...
	return getSqlSession().delete(msId, value);
    }
	...
	private MSUtils(Configuration configuration) {
	    ...
	    languageDriver = configuration.getLanguageRegistry().getDefaultDriver();
	}
